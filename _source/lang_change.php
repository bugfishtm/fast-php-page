...
<html>
  <head>
	...
	<title>Language Changer - <?php echo _INSTALLER_TITLE_; ?></title>
    <style>
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h2 style="padding-bottom: 0px;margin-bottom: 0px;"><?php echo _INSTALLER_TITLE_; ?></h2>Language Change<br />
                        <hr><p><b>Change website language:</b><br />Here you can change this websites language if available!</p><hr>
						
						

						<b>Current Site-Lang</b>: <?php echo _HIVE_LANG_; ?><br />
						<b>Current Site-Lang (SESSION)</b>: <?php echo @$_SESSION[$object["cookie"]._HIVE_MODE_."hive_language"]; ?><br />
						<b>Current Site-Lang (DEFAULT)</b>: <?php echo _HIVE_LANG_DEFAULT_; ?><br />
						<b>Current Site-Lang (ARRAY)</b>: <span style='word-break: break-all;'><?php echo @serialize(@_HIVE_LANG_ARRAY_); ?></span>
						
						<?php echo "<hr>";
										if(@is_string(@$_POST["mod_change"]) AND @in_array(@$_POST["mod_change"], @_HIVE_LANG_ARRAY_)) {
											@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_language"] = @$_POST["mod_change"];
											echo "<script>window.location.href = window.location.href;</script>";
										}

						?>
							<form method="post">
								<select name="mod_change">
								<option value="<?php echo htmlentities(@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_language"]); ?>">Aktuell: <?php echo htmlentities(@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_language"]); ?></option>
									<?php
