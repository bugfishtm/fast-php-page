<?php
	...
	*/
	...
	if(file_exists("./settings.php")) {
		...
		if(!defined("_HIVE_VERSION_ACTIVE_")) { 
			hive_error_full("Critical Error", "_HIVE_VERSION_ACTIVE_ not found while initializing the Side Module: '".@htmlspecialchars(_HIVE_MODE_ ?? '')."'!", "Please check the version.php informations of the deployed module.", true, 503);
		}
		...
		if(_HIVE_VERSION_ACTIVE_ == 0) { 
			hive_error_full("Critical Error", "_HIVE_VERSION_ACTIVE_ is NULL while initializing the Side Module: '".@htmlspecialchars(_HIVE_MODE_ ?? '')."'!", "Please check the version.php informations of the deployed module.", true, 503);		
		}
