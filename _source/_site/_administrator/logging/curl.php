<?php
	...
	*/
	...
	if(!hive__access($object, "admin_logging", false) AND $object["user"]->user["user_initial"] != 1) {
		...
		$item_general 	= "Curl Entry";
		$text_general 	= "Gain detailed insights into Curl logging activities on your website with comprehensive logs and data available in this dedicated section, enabling efficient monitoring and analysis.";
