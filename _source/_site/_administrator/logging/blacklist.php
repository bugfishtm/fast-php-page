<?php
	...
	*/
	...
	if(!hive__access($object, "admin_logging", false) AND $object["user"]->user["user_initial"] != 1) {
		...
		// Variables
		////////////////////////////////////////////////////////////////
		$title_general 	= "Blacklist";
		$trts_general 	= "creation, ip_adr, fail, id";
		$item_general 	= "Blacklist Entry";
		$text_general 	= "Effectively manage and monitor IP blacklists to ensure enhanced security and control over unauthorized access in this dedicated section.";
