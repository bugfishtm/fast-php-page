<?php
	...
	*/
	...
	if(!hive__access($object, "admin_logging", false) AND $object["user"]->user["user_initial"] != 1) {
		...
		////////////////////////////////////////////////////////////////
		$title_general 	= "JS";
		$trts_general 	= "creation, urlstring, errormsg, section, id";
		$item_general 	= "JS Entry";
		$text_general 	= "Monitor and troubleshoot JavaScript errors effectively with detailed logging available in this dedicated section, empowering you to maintain a smooth and error-free website experience for users.";
		$table_general 	= _TABLE_LOG_JS_;
		...
		if(is_array($value_array)) {
			foreach($value_array as $key => $value) {
				...
				$value_array[$key]["urlstring"] = @htmlspecialchars($value_array[$key]["urlstring"]);
				$value_array[$key]["errormsg"] = @htmlspecialchars($value_array[$key]["errormsg"]);
