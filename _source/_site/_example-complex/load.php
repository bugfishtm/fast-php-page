<?php
	...
	*/
	...
	hive__dashboard_header($object, "Complex Theme", '<link rel="icon" type="image/x-icon" href="'._HIVE_URL_REL_.'/_core/_image/favicon.ico">', "dark");
	hive__dashboard_nav($object, "Complex Theme", array(hive_get_url_rel(array("create", false, false, false, false)), "Create Account"));
