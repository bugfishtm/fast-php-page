<?php
	...
	*/ if(file_exists("./settings.php")) { require_once("./settings.php"); } else { @http_response_code(404); Header("Location: ./"); exit(); } 
	...
	if(_HIVE_BUILD_ <= _HIVE_BUILD_ACTIVE_) { 
		hive_error_full("No Update Required", "ERROR", "This software is already updated!", true, 404); }
	...
	hive__simple_start($object, "Updater", '<link rel="icon" type="image/x-icon" href="'._HIVE_URL_REL_.'/_core/_image/favicon.ico">'); ?>
    <div class="containerbox">
		<img src='./_core/_image/logo_alpha.png' width='40' style="margin-right: 10px;" > <b style='font-size:36px; padding-bottom: 10px;'><?php echo _UPDATER_TITLE_; ?> Updater</b>
