              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h2 style="padding-bottom: 0px;margin-bottom: 0px;">System</h2>Mod-Change<br />
                        <hr><p><b>Change website mode:</b><br />Here you can change this websites mode if available!</p><hr>
						
						

						<b>Current Site-Mode</b>: <?php echo _HIVE_MODE_; ?><br />
						<b>Current Site-Mode (SESSION)</b>: <?php echo @$_SESSION[_HIVE_COOKIE_."hive_mode"]; ?><br />
						<b>Current Site-Mode (DEFAULT)</b>: <?php echo _HIVE_MODE_DEFAULT_; ?><br />
						<b>Current Site-Mode (ARRAY)</b>: <span style='word-break: break-all;'><?php echo @serialize(@_HIVE_MODE_ARRAY_); ?></span>
						...
						?>
							<form method="post">
								...
								<option value="<?php echo htmlentities($_SESSION[_HIVE_COOKIE_."hive_mode"] ); ?>">Aktuell: <?php echo htmlentities($_SESSION[_HIVE_COOKIE_."hive_mode"] ); ?></option>
									<?php
