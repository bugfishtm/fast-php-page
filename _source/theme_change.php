...
<html>
  <head>
	...
	<title>Theme Changer - <?php echo _INSTALLER_TITLE_; ?></title>
    <style>
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h2 style="padding-bottom: 0px;margin-bottom: 0px;"><?php echo _INSTALLER_TITLE_; ?></h2>Theme Change<br />
                        <hr><p><b>Change website theme:</b><br />Here you can change this websites theme if available!</p><hr>
						...
						<b>Current Site-Theme (ARRAY)</b>: <span style='word-break: break-all;'><?php echo @serialize(@_HIVE_THEME_ARRAY_); ?></span>
						
						<?php echo "<hr>";
										if(@is_string(@$_POST["mod_change"]) AND @in_array(@$_POST["mod_change"], @_HIVE_THEME_ARRAY_)) {
											@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_theme"] = @$_POST["mod_change"];
						...
						?>
							<form method="post">
								...
								<option value="<?php echo htmlentities(@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_theme"]); ?>">Aktuell: <?php echo htmlentities(@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_theme"]); ?></option>
									<?php
