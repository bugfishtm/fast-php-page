	...
	*/ if(!is_array($object)) { @http_response_code(@404); @Header("Location: ../"); exit(); }
	...
	function hive_error_full($title, $subtitle, $description, $exit, $code) { 
		...
		<head>
			...
			<?php if(defined("_HIVE_URL_REL_")) { ?> <link rel="icon" type="image/x-icon" href="<?php echo _HIVE_URL_REL_; ?>/_core/_images/favicon.ico"> <?php } ?>
			<title><?php echo $title; ?><?php if(defined("_HIVE_TITLE_SPACER_")) { echo _HIVE_TITLE_SPACER_; } else { echo " - "; } ?><?php if(defined("_HIVE_TITLE_")) { echo _HIVE_TITLE_; } else { echo "HIVE"; } ?></title>
