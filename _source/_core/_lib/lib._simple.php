<?php
	...
	*/
	...
	function hive__simple_start($object, $tabtitle = "", $metaextensions = "") {  if(!defined("_HIVE_COLOR_")) { define("_HIVE_COLOR_", "yellow");} ?>
<!doctype html>
<html>
  <head>
