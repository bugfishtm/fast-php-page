<?php
	...
	*/
	...
	<?php if($exit) { exit(); } }
	hive_error_full("Scheduled Maintenance", "533", "This site is currently down for maintenance.<br />
						Our service team is working hard to bring it back online soon.", true, 533);
?>