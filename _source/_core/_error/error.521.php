<?php
	...
	*/
	...
	<?php if($exit) { exit(); } }
	hive_error_full("Webservice currently unavailable", "521", "We've got some trouble with our backend upstream cluster.<br />
						Our service team has been dispatched to bring it back online.", true, 521);
?>