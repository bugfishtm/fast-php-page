<?php
	...
	*/
	...
	<?php if($exit) { exit(); } }
	hive_error_full("Webservice currently unavailable", "500", "An unexpected condition was encountered.<br />
							Our service team has been dispatched to bring it back online.", true, 500);
?>