<?php
	...
	*/ if(!is_array($object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_PREFIX_."sys_forward` (
		  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
		  `fw_string` varchar(128) NOT NULL COMMENT 'Identifier String',
		  `fw_target` text NOT NULL COMMENT 'URL Target',
		  `fw_hits` int(11) NOT NULL COMMENT 'URL Clicks',
		  ...
		  PRIMARY KEY (`id`),
		  UNIQUE KEY `sys_forward` (`fw_string`,`section`) USING BTREE
		);");	
