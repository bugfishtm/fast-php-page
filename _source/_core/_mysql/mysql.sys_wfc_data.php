<?php
	...
	*/ if(!is_array($object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
		$object["mysql"]->multi_query("
			CREATE TABLE IF NOT EXISTS `"._HIVE_PREFIX_."sys_wfc_data` (
			  `id` int(11) NOT NULL AUTO_INCREMENT,
			  `fk_relation` int(11) NOT NULL DEFAULT 0 COMMENT 'Related Object',
			  `fk_link` int(11) NOT NULL DEFAULT 0 COMMENT 'Related Link',
			  `fk_link_name` text NOT NULL DEFAULT 0 COMMENT 'Related Link Name',
			  `wfc_content` text NULL,
			  `wfc_data` text NULL,
