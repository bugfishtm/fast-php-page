<?php
	...
	*/ if(!is_array($object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
		$object["mysql"]->multi_query("
			CREATE TABLE IF NOT EXISTS `"._HIVE_PREFIX_."sys_file_share` (
			  `id` int(11) NOT NULL AUTO_INCREMENT,
			  `fk_creator` int(11) NULL,
			  `fk_user` int(11) NULL,
			  `fk_group` int(11) NULL,
			  `fk_file` int(11) NULL,
			  `fk_file_folder` int(11) NULL,
			  ...
			  UNIQUE KEY `sys_file_user_link` (`fk_user`,`fk_group`,`fk_file`,`fk_file_folder`) USING BTREE );
		");