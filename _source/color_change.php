...
<html>
  <head>
	...
	<title>Color Changer - <?php echo _INSTALLER_TITLE_; ?></title>
    <style>
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h2 style="padding-bottom: 0px;margin-bottom: 0px;"><?php echo _INSTALLER_TITLE_; ?></h2>Color Change<br />
                        <hr><p><b>Change website color:</b><br />Here you can change this websites color if available!</p><hr>
						<b>Current Site-Theme</b>: <?php echo _HIVE_THEME_; ?><br />
						<b>Current Site-Theme (SESSION)</b>: <?php echo @$_SESSION[$object["cookie"]._HIVE_MODE_."hive_theme"]; ?><br />
						<b>Current Site-Theme (DEFAULT)</b>: <?php echo _HIVE_THEME_DEFAULT_; ?><br />
						<b>Current Site-Theme (ARRAY)</b>: <span style='word-break: break-all;'><?php echo @serialize(@_HIVE_THEME_ARRAY_); ?></span><br /><br />
						<b>Current Site-Color</b>: <?php echo _HIVE_COLOR_; ?><br />
						<b>Current Site-Color (SESSION)</b>: <?php echo @$_SESSION[$object["cookie"]._HIVE_MODE_."hive_color"]; ?><br />	
						<b>Current Site-Color (DEFAULT)</b>: <?php echo _HIVE_THEME_COLOR_DEFAULT_; ?><br />		
						
						<?php echo "<hr>";
										if(@is_string(@$_POST["mod_change"])) {
											@$_SESSION[$object["cookie"]._HIVE_MODE_."hive_color"] = @$_POST["mod_change"];
											echo "<script>window.location.href = window.location.href;</script>";
										}

						?>
							<form method="post">
								<input type="color" name="mod_change" value='<?php echo _HIVE_COLOR_; ?>'>
								<br /><br />
									...
									<table role="presentation" border="0" cellpadding="0" cellspacing="0">
									  <tbody>
										<tr><input type="hidden" name="update_start" value="set">
										  <td> <button type="submit" style="background: none;color: white; border: none; outline: none;cursor: pointer; padding: 15px;font-weight: bold;font-family:sans-serif">Change</button> </td>
										</tr>
									  </tbody>
									</table>
								  </td>
